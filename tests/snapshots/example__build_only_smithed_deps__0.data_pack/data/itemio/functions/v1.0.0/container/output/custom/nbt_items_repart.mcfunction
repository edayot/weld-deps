...
execute if entity @s[tag=itemio.container.nbt_items.on_passengers] on passengers run function itemio:v1.0.0/container/output/custom/nbt_items with storage itemio:main.output {}
execute if entity @s[tag=itemio.container.nbt_items.on_vehicle] on vehicle run function itemio:v1.0.0/container/output/custom/nbt_items with storage itemio:main.output {}
execute if entity @s[tag=!itemio.container.nbt_items.on_passengers, tag=!itemio.container.nbt_items.on_vehicle] run function itemio:v1.0.0/container/output/custom/nbt_items with storage itemio:main.output {}
