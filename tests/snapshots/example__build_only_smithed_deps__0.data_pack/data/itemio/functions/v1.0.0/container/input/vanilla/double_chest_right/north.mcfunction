...
execute if score #success_input itemio.io matches 0 positioned ~-1 ~ ~ if block ~ ~ ~ chest[facing=north, type=left] run function itemio:v1.0.0/container/input/vanilla/try_input
