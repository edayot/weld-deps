...
execute if entity @s[type=armor_stand] run data modify storage itemio:main.output ioconfig set from entity @s ArmorItems[3].components."minecraft:custom_data".itemio.ioconfig
