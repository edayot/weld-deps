...
execute if score #success_transfer itemio.io matches 0 if data storage itemio:main servo_items_loop[0] run function itemio:v1.5.3/servo/make_transfer_items
