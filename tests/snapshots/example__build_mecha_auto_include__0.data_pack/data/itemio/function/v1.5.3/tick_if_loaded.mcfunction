...
execute as @e[type=#itemio:servos, tag=itemio.servo.extract, tag=itemio.servo.initialised, predicate=itemio:v1.5.3/internal/good_queue, sort=random] run function itemio:v1.5.3/servo/test_already
