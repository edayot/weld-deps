...
execute align xyz positioned ~0.5 ~0.5 ~0.5 as @e[type=#itemio:network, tag=itemio.network, tag=!itemio.cable, distance=..0.5001] run function itemio:v1.5.3/servo/calc_cable_model
