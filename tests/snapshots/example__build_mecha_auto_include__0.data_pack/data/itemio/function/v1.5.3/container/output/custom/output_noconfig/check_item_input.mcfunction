...
execute if score #!same_item itemio.math.output matches 0 run function itemio:v1.5.3/container/output/custom/output_noconfig/check_filters with storage itemio:main.output temp.args_check_filters
