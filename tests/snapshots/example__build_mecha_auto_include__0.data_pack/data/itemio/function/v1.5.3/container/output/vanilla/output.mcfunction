...
execute if block ~ ~ ~ #itemio:container/normal_chest if data storage itemio:main.output Items[0] run function itemio:v1.5.3/container/output/vanilla/output/loop_item

execute if block ~ ~ ~ #itemio:container/chests[type=single] if data storage itemio:main.output Items[0] run function itemio:v1.5.3/container/output/vanilla/output/loop_item

execute if block ~ ~ ~ #itemio:container/chests[type=right] run function itemio:v1.5.3/container/output/vanilla/double_chest_right

execute if block ~ ~ ~ #itemio:container/chests[type=left] run function itemio:v1.5.3/container/output/vanilla/double_chest_left
