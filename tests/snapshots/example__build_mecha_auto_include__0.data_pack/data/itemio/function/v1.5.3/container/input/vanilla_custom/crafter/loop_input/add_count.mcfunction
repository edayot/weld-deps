...
execute if score #count_input itemio.math.input matches 1.. if score #full_input itemio.math.input matches 0 if data storage itemio:main.input Items_min_count[0] run function itemio:v1.5.3/container/input/vanilla_custom/crafter/loop_input/add_count with storage itemio:main.input Items_min_count[0]
