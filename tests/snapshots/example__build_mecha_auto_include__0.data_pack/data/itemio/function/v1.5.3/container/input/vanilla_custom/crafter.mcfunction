...
function itemio:v1.5.3/container/input/vanilla_custom/crafter/cleaning {slot_clean: 0}

execute if data storage itemio:main.input disabled_slots[0] if data storage itemio:main.input Items_clean[0] run function itemio:v1.5.3/container/input/vanilla_custom/crafter/delete_disabled
...
execute if score #count_input itemio.math.input matches 1.. if data storage itemio:main.input Items_clean[0] run function itemio:v1.5.3/container/input/vanilla_custom/crafter/loop_input

execute if score #success_input itemio.math.input matches 1 run function itemio:v1.5.3/container/input/vanilla_custom/crafter/success
