...
execute if score #needed_stack itemio.math.input <= #block_size itemio.math.input run function itemio:v1.5.3/container/input/vanilla/inf_insert

execute if score #needed_stack itemio.math.input > #block_size itemio.math.input run function itemio:v1.5.3/container/input/vanilla/sup_insert
