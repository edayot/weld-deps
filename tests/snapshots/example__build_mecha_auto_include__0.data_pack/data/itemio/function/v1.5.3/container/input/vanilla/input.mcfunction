...
execute unless score #block_size itemio.math.input matches 0 run function itemio:v1.5.3/container/input/vanilla/try_input

execute if block ~ ~ ~ #itemio:container/chests[type=left] run function itemio:v1.5.3/container/input/vanilla/double_chest_left

execute if block ~ ~ ~ #itemio:container/chests[type=right] run function itemio:v1.5.3/container/input/vanilla/double_chest_right
