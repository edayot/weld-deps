...
execute if score #loop_count_input itemio.math.input matches 1.. run function itemio:v1.5.3/container/input/vanilla/inf_insert/loop_items

# tellraw @a [{"text":"storage : "},{"nbt":"inputs","storage":"itemio:main.input"}]

execute in minecraft:overworld run function itemio:v1.5.3/container/input/vanilla/inf_insert/dimension
