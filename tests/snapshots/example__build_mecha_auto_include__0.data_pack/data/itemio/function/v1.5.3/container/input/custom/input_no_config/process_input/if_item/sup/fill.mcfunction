...
execute if score #nbt_items itemio.math.input matches 1 run function itemio:v1.5.3/container/input/custom/input_no_config/process_input/if_item/sup/fill/nbt_items with storage itemio:main.input temp.args
