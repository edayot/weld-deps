...
execute if score #filters.valid_item itemio.io matches 1 run function itemio:v1.5.3/container/output/vanilla/output/process with storage itemio:main.output temp.args_loop_item
