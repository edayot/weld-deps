...
$execute if score #remove_count itemio.math.output matches 1.. if score #nbt_items itemio.math.output matches 0 run item modify block ~ ~ ~ container.$(Slot) itemio:v1.0.0/internal/output/remove_count
execute if score #remove_count itemio.math.output matches 1.. if score #nbt_items itemio.math.output matches 1 run function itemio:v1.0.0/container/output/custom/output_noconfig/remove_count_nbt_items
