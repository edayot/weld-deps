...
execute if score #nbt_items itemio.math.output matches 1 run function itemio:v1.2.6/container/output/custom/nbt_items_repart
...
execute if score #nbt_items itemio.math.output matches 1 if score #nb_entities itemio.math.output matches 1 if data storage itemio:main.output ioconfig[0] run function itemio:v1.2.6/container/output/custom/output_noconfig/loop_ioconfig with storage itemio:main.output temp.args_loop_ioconfig
execute if score #nbt_items itemio.math.output matches 0 if data storage itemio:main.output ioconfig[0] run function itemio:v1.2.6/container/output/custom/output_noconfig/loop_ioconfig with storage itemio:main.output temp.args_loop_ioconfig
