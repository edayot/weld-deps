...
execute if score #nbt_items itemio.math.input matches 1 run function itemio:v1.2.6/container/input/custom/input_no_config/process_input/unless_item/sup/nbt_items with storage itemio:main.input temp.args
