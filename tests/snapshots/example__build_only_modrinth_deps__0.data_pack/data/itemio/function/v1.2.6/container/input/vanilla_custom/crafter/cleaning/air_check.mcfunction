...
$execute unless data storage itemio:main.input temp.item_crafter{id:"do_not_useFDSDFS"} run function itemio:v1.2.6/container/input/vanilla_custom/crafter/cleaning/nbt_check {slot_clean:$(slot_clean)}
