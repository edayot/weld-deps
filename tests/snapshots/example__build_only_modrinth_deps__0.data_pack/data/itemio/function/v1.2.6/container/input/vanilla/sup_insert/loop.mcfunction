...
function itemio:v1.2.6/container/input/custom/input_no_config/process_input with storage itemio:main.input temp.args
scoreboard players add #temp_slot itemio.math.input 1
function itemio:v1.2.6/container/input/if_item_input
execute if score #temp_success_lol itemio.math.input matches 1 if score #temp_slot itemio.math.input < #block_size itemio.math.input run function itemio:v1.2.6/container/input/vanilla/sup_insert/loop
