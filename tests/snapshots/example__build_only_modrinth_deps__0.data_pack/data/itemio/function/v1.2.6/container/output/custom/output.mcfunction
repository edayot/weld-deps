...
execute if score #ioconfig_from_storage itemio.math.output matches 0 run function itemio:v1.2.6/container/output/custom/input_normal
execute if score #ioconfig_from_storage itemio.math.output matches 1 run function itemio:v1.2.6/container/output/custom/input_storage
...
execute if data storage itemio:main.output ioconfig run function itemio:v1.2.6/container/output/custom/output_noconfig
