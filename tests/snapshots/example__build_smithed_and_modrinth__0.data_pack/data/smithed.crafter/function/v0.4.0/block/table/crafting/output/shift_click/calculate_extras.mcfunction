...
item modify block ~ ~ ~ container.2 smithed.crafter:v0.4.0/set_count_from_score

execute store result score @s smithed.data run data get block ~ ~ ~ Items[{Slot: 3b}].count
scoreboard players operation @s smithed.data -= $temp2 smithed.data
item modify block ~ ~ ~ container.3 smithed.crafter:v0.4.0/set_count_from_score

execute store result score @s smithed.data run data get block ~ ~ ~ Items[{Slot: 4b}].count
scoreboard players operation @s smithed.data -= $temp2 smithed.data
item modify block ~ ~ ~ container.4 smithed.crafter:v0.4.0/set_count_from_score

execute store result score @s smithed.data run data get block ~ ~ ~ Items[{Slot: 11b}].count
scoreboard players operation @s smithed.data -= $temp2 smithed.data
item modify block ~ ~ ~ container.11 smithed.crafter:v0.4.0/set_count_from_score

execute store result score @s smithed.data run data get block ~ ~ ~ Items[{Slot: 12b}].count
scoreboard players operation @s smithed.data -= $temp2 smithed.data
item modify block ~ ~ ~ container.12 smithed.crafter:v0.4.0/set_count_from_score

execute store result score @s smithed.data run data get block ~ ~ ~ Items[{Slot: 13b}].count
scoreboard players operation @s smithed.data -= $temp2 smithed.data
item modify block ~ ~ ~ container.13 smithed.crafter:v0.4.0/set_count_from_score

execute store result score @s smithed.data run data get block ~ ~ ~ Items[{Slot: 20b}].count
scoreboard players operation @s smithed.data -= $temp2 smithed.data
item modify block ~ ~ ~ container.20 smithed.crafter:v0.4.0/set_count_from_score

execute store result score @s smithed.data run data get block ~ ~ ~ Items[{Slot: 21b}].count
scoreboard players operation @s smithed.data -= $temp2 smithed.data
item modify block ~ ~ ~ container.21 smithed.crafter:v0.4.0/set_count_from_score

execute store result score @s smithed.data run data get block ~ ~ ~ Items[{Slot: 22b}].count
scoreboard players operation @s smithed.data -= $temp2 smithed.data
item modify block ~ ~ ~ container.22 smithed.crafter:v0.4.0/set_count_from_score
...
function smithed.crafter:v0.4.0/block/table/crafting/input/read_barrel
data modify storage smithed.crafter:main root.temp.item set from block ~ ~ ~ Items[{Slot: 16b}]
data remove block ~ ~ ~ Items[{Slot: 16b}]

execute as @p[distance=..12, tag=smithed.inside_crafter, tag=smithed.shift_clicked] at @s run function smithed.crafter:v0.4.0/block/table/crafting/output/shift_click/spawn_extra_items
function smithed.crafter:v0.4.0/block/table/crafting/input/read_barrel
